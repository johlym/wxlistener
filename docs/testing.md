...
- [Running Tests](#running-tests)
  ...
  - [Run Tests in Release Mode](#run-tests-in-release-mode)
- [Test Coverage](#test-coverage)
  - [Unit Tests](#unit-tests)
    - [`decoder.rs` Tests](#decoderrs-tests)
    - [`protocol.rs` Tests](#protocolrs-tests)
  - [Integration Tests](#integration-tests)
    - [`integration_test.rs`](#integration_testrs)
- [Manual Testing](#manual-testing)
  - [Test with Real Device](#test-with-real-device)
...
- [Test Data](#test-data)
  - [Sample Binary Responses](#sample-binary-responses)
    - [Firmware Version Response](#firmware-version-response)
    - [MAC Address Response](#mac-address-response)
...
- [Coverage](#coverage)
  - [Using tarpaulin (Linux/macOS)](#using-tarpaulin-linuxmacos)
  - [Using llvm-cov](#using-llvm-cov)
- [Debugging Tests](#debugging-tests)
  - [Run with backtrace](#run-with-backtrace)
  - [Run single test with output](#run-single-test-with-output)
  - [Run tests in single thread](#run-tests-in-single-thread)
- [Known Limitations](#known-limitations)
- [Advanced Testing](#advanced-testing)
  - [Property-Based Testing](#property-based-testing)
  - [Mock TCP Server](#mock-tcp-server)
- [Fuzzing](#fuzzing)
